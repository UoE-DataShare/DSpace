...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- The string constant used for the Creative Commons Attribution 4.0 rights statement in
         the class uk.ac.edina.datashare.utils.Consts.java -->
    <xsl:variable name="ccbyrights">Creative Commons Attribution 4.0 International Public License</xsl:variable>
    <!-- The string constant used for the Creative Commons Attribution 4.0 rights URI -->
