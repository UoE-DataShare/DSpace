...
// DATASHARE -- start
importClass(Packages.org.dspace.eperson.factory.DatashareEPersonServiceFactory);
// DATASHARE -- end
/**
...
{ 
    ...
    getDatashareAccountService().getLogger().log("token: " + token);
    ...
    if (token == null) 
    {
        ...
        do {
            ...
            getDatashareAccountService().getLogger().log("uun: " +  uun);
            ...
            getDatashareAccountService().getLogger().log("submit_forgot: " + submit_forgot);
            ...
            getDatashareAccountService().getLogger().log("email: " + email);
            ...
            getDatashareAccountService().getLogger().log("canRegister: " + canRegister);
            ...
            if (canRegister) 
            {
                try 
                {
                    ...
                    var uun = cocoon.request.getParameter("uun");
                    getDatashareAccountService().getLogger().log("Register account for " + uun);
    ...
    else 
    {
        ...
        getDatashareAccountService().getLogger().log("We have a token for email " + email);
        ...
        getDatashareAccountService().getLogger().log("setPassword " + setPassword);
        ...
        do {
            ...
            getDatashareAccountService().getLogger().log("eperson " + eperson);
            if (eperson == null)
            {
